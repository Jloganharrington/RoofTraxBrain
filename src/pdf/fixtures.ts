...
export const sampleInspection: SubmittedInspection = {
  ...
  photos: [
    { id: 'ph-overview', stage: 'arrival', subjectType: 'inspection', subjectId: null, url: 'objstore://p/overview.jpg', sha256: '1'.repeat(64), triadRole: null, capturedAtUtc: '2026-05-20T13:31:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Front of home' },
    { id: 'ph-elev-front', stage: 'elevation_access', subjectType: 'elevation', subjectId: 'elev-front', url: 'objstore://p/elev-front.jpg', sha256: '2'.repeat(64), triadRole: 'wide', capturedAtUtc: '2026-05-20T13:33:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Front elevation' },
    { id: 'ph-slope-front', stage: 'facets', subjectType: 'slope', subjectId: 'slope-front', url: 'objstore://p/slope-front.jpg', sha256: '3'.repeat(64), triadRole: 'wide', capturedAtUtc: '2026-05-20T13:40:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Front slope overview' },
    { id: 'ph-dmg1-wide', stage: 'facets', subjectType: 'damage_instance', subjectId: 'dmg-1', url: 'objstore://p/dmg1-wide.jpg', sha256: '4'.repeat(64), triadRole: 'wide', capturedAtUtc: '2026-05-20T13:45:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Hail damage wide' },
    { id: 'ph-dmg1-close', stage: 'facets', subjectType: 'damage_instance', subjectId: 'dmg-1', url: 'objstore://p/dmg1-close.jpg', sha256: '5'.repeat(64), triadRole: 'close', capturedAtUtc: '2026-05-20T13:46:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Hail damage close (scale)' },
    { id: 'ph-ts-front', stage: 'test_squares', subjectType: 'test_square', subjectId: 'ts-front', url: 'objstore://p/ts-front.jpg', sha256: '6'.repeat(64), triadRole: 'wide', capturedAtUtc: '2026-05-20T13:50:00Z', gpsLat: 38.8462, gpsLng: -77.3064, caption: 'Front test square' },
  ],
  attestations: [
    { id: 'att-equip', stage: 'arrival', attestationType: 'equipment', details: { equipment: ['ladder', 'chalk', 'gauge'] }, hash: '7'.repeat(64) },
    { id: 'att-sign', stage: 'declaration', attestationType: 'stage_signoff', details: { declarationHash: '8'.repeat(64) }, hash: '9'.repeat(64) },
    { id: 'att-final', stage: 'submit', attestationType: 'stage_signoff', details: { kind: 'final_review' }, hash: '0'.repeat(64) },
  ],
  addenda: [],
